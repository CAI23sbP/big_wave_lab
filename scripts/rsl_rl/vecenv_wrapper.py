...
from big_wave_lab.envs import ManagerBasedRLEnv as BigWaveLabManagerBasedRLEnv
...
class RslRlVecEnvWrapper(VecEnv):
    ...
    def __init__(self, env: ManagerBasedRLEnv | DirectRLEnv, clip_actions: float | None = None):
        ...
        if isinstance(env.unwrapped, ManagerBasedRLEnv) and isinstance(env.unwrapped, DirectRLEnv):
            pass 
        
        elif isinstance(env.unwrapped, BigWaveLabManagerBasedRLEnv):
            pass
        else:
            raise ValueError(
